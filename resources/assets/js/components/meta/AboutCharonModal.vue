<template>
  <div v-charon-focus class="about text-secondary" data-testid="about-charon" tabindex="0" @keydown.esc="close">
    <main>
      <div class="logo">
        <img alt="Charon's logo" src="@/../img/logo.png" width="128">
      </div>

      <p class="current-version">Charon {{ currentVersion }}</p>
