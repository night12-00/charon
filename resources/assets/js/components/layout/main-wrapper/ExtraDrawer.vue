  ...
  <aside :class="{ 'showing-pane': activeTab }">
    <div class="controls">
      ...
      <div class="bottom">
        ...
        <button v-charon-tooltip.left title="Log out" type="button" @click.prevent="logout">
...
const ProfileAvatar = defineAsyncComponent(()=>import('@/components/ui/ProfileAvatar.vue'))
