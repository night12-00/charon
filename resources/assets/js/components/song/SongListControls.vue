  ...
  <div ref="el" class="song-list-controls" data-testid="song-list-controls">
    <div class="wrapper">
      ...
      <BtnGroup v-if="config.refresh || config.deletePlaylist">
        <Btn v-if="config.refresh" v-charon-tooltip green title="Refresh" @click.prevent="refresh">
    ...
    <div ref="addToMenu" v-charon-clickaway="closeAddToMenu" class="menu-wrapper">
