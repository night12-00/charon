...
class UploadServiceTest extends TestCase
{
    ...
    {
        Setting::set('media_path', '/media/charon');
        ...
        $file->shouldReceive('move')
            ->once()
            ->with('/media/charon/__CHARON_UPLOADS__/', 'foo.mp3');
        ...
        $this->fileSynchronizer
            ...
            ->once()
            ->with()
            ->andReturn(SyncResult::error('/media/charon/__CHARON_UPLOADS__/foo.mp3', 'A monkey ate your file oh no'));
    ...
    public function testHandleUploadedFile(): void
    {
        ...
        $this->fileSynchronizer
            ->shouldReceive('sync')
            ->once()
            ->andReturn(SyncResult::success('/media/charon/__CHARON_UPLOADS__/foo.mp3'));
